				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table>
							...
							<tbody>
								<tr>
									<td class="center">${bdbResult.formatDate}</td>
									<td class="center">${bdbResult.deliveryMethodName}</td>
									<td class="center">${bdbResult.totalPrice}円</td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="card-content">
						<table class="bordered">
							...
							<tbody>
								...
								<tr>
									<td class="center">${bdbResult.deliveryMethodName}</td>
									<td class="center">${bdbResult.deliveryMethodPrice}円</td>
								</tr>
							</tbody>
						</table>
					</div>
